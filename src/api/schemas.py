...
class ModelInfo(BaseModel):
    ...
    id: str = Field(..., example="ollama/llama3.2")
    name: str = Field(..., example="Llama 3.2 (Local)")
...
class ChatRequest(BaseModel):
    ...
    model_override: Optional[str] = Field(None, description="Optional model to route to (e.g. 'ollama/llama3.2')")
...
class Ship30Request(BaseModel):
    ...
    guest_filter: Optional[str] = Field(None, description="Optional guest to emphasize (e.g. 'Brian Chesky')")
